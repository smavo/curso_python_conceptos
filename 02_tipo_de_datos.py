...
# Listas: Son colecciones ordenadas y modificables de elementos. Los elementos pueden ser de diferentes tipos. Por ejemplo: 
number = [1, 2, 3]
fruits = ['manzana', 'banana', 'cereza']
print(number, fruits)


# Tuplas: Son colecciones ordenadas e inmutables de elementos. Una vez que se crean, no se pueden modificar. Por ejemplo:
num = (1, 2, 3)
print(num)


# Diccionarios: Son colecciones desordenadas de pares clave-valor. Se utilizan para mapear claves a valores. Por ejemplo:
tp =  {'nombre': 'Juan', 'edad': 30}
print(tp)


# Conjuntos (set): Son colecciones desordenadas de elementos únicos. Se utilizan para realizar operaciones matemáticas de conjunto. Por ejemplo: {1, 2, 3}.
cjtos = {1, 2, 3}


# NoneType: Representa la ausencia de valor. Especialmente útil para indicar que una variable no tiene un valor asignado.
ntp = None
print(ntp)
